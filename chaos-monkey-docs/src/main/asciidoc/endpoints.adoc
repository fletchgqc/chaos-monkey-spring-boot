...
----
===== GET Watchers
GET Watchers is documented with OpenAPI 3, see our link:swagger-ui/[OpenAPI documentation]. (We hope to document all rest endpoints there in the near future).
